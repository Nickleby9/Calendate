...
public class CaldroidGridAdapter extends BaseAdapter {
    ...
    private void populateFromCaldroidData() {
        disableDates = (ArrayList<DateTime>) caldroidData
                .get(com.roomorama.caldroid.CaldroidFragment.DISABLE_DATES);
        ...
        selectedDates = (ArrayList<DateTime>) caldroidData
                .get(com.roomorama.caldroid.CaldroidFragment.SELECTED_DATES);
        ...
        minDateTime = (DateTime) caldroidData
                .get(com.roomorama.caldroid.CaldroidFragment._MIN_DATE_TIME);
        maxDateTime = (DateTime) caldroidData
                .get(com.roomorama.caldroid.CaldroidFragment._MAX_DATE_TIME);
        startDayOfWeek = (Integer) caldroidData
                .get(com.roomorama.caldroid.CaldroidFragment.START_DAY_OF_WEEK);
        sixWeeksInCalendar = (Boolean) caldroidData
                .get(com.roomorama.caldroid.CaldroidFragment.SIX_WEEKS_IN_CALENDAR);
        squareTextViewCell = (Boolean) caldroidData
                .get(com.roomorama.caldroid.CaldroidFragment.SQUARE_TEXT_VIEW_CELL);

        // Get theme
        themeResource = (Integer) caldroidData
                .get(com.roomorama.caldroid.CaldroidFragment.THEME_RESOURCE);
    ...
    protected void setCustomResources(DateTime dateTime, View backgroundView,
        ...
        Map<DateTime, Drawable> backgroundForDateTimeMap = (Map<DateTime, Drawable>) caldroidData
                .get(com.roomorama.caldroid.CaldroidFragment._BACKGROUND_FOR_DATETIME_MAP);
        ...
        Map<DateTime, Integer> textColorForDateTimeMap = (Map<DateTime, Integer>) caldroidData
                .get(com.roomorama.caldroid.CaldroidFragment._TEXT_COLOR_FOR_DATETIME_MAP);

...
public class CaldroidFragment extends DialogFragment {
    ...
    public void moveToDateTime(DateTime dateTime) {
        ...
        DateTime firstOfMonth = new DateTime(mCalendar.get(Calendar.YEAR), mCalendar.get(Calendar.MONTH)+1, 1, 0, 0, 0, 0);
        ...
        if (dateTime.lt(firstOfMonth)) {
            ...
            // decrease
            DateTime firstDayNextMonth = dateTime.plus(0, 2, 0, 0, 0, 0, 0,
        ...
        // Calendar swipe right when dateTime is in the future
            ...
            // increase
            DateTime firstDayLastMonth = dateTime.minus(0, 2, 0, 0, 0, 0, 0,
                    DateTime.DayOverflow.LastDay);
    ...
    public void setCalendarDateTime(DateTime dateTime) {
        ...
        if (caldroidListener != null) {
            caldroidListener.onChangeMonth(mCalendar.get(Calendar.MONTH), mCalendar.get(Calendar.YEAR));
        }
    ...
    private void nextYear() {
        ...
        DateTime dateTime = new DateTime(mCalendar.get(Calendar.YEAR), mCalendar.get(Calendar.MONTH)+1, mCalendar.get(Calendar.DAY_OF_MONTH),0,0,0,0);
        moveToDate(time);

        // Refresh adapters
        pageChangeListener.setCurrentDateTime(dateTime);
        dateViewPager.setCurrentItem(dateViewPager.getCurrentItem()+12);
    ...
    protected void refreshMonthTitleTextView() {
        // Refresh title view
        firstMonthTime.year = mCalendar.get(Calendar.YEAR);
        firstMonthTime.month = mCalendar.get(Calendar.MONTH) - 1;
    ...
    public void refreshView() {
        ...
        // anything
//        if (mCalendar.get(Calendar.MONTH) == -1 || mCalendar.get(Calendar.YEAR) == -1) {
//            return;
//        }
...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = localInflater.inflate(com.calendate.calendate.R.layout.calendar_view, container, false);
...
//        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), com.calendate.calendate.R.drawable.ic_dot);
//        BitmapDrawable drawable = new BitmapDrawable(getResources(), bitmap);
        ...
        mDatabase.getReference("all_events/" + user.getUid()).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    setBackgroundDrawableForDate(dot, eventDate.toDate());
                    refreshView();
                }
            }
    ...
    private void startTouchTypeDetection() {
        Sensey.getInstance().startTouchTypeDetection(getContext(), new TouchTypeDetector.TouchTypListener() {
            @Override
            ...
            public void onSwipe(int i) {
                switch (i) {
                    case TouchTypeDetector.SWIPE_DIR_UP:
                        moveToDateTime(DateTime.forDateOnly(mCalendar.get(Calendar.YEAR)+1, mCalendar.get(Calendar.MONTH), 1));
                        break;
    ...
    private void setupDateGridPages(View view) {
        ...
        DateTime currentDateTime = new DateTime(mCalendar.get(Calendar.YEAR), mCalendar.get(Calendar.MONTH), 1, 0, 0, 0, 0);
    ...
    public class DatePageChangeListener implements OnPageChangeListener {
        ...
        public void refreshAdapters(int position) {
            ...
            // Swipe right
                ...
                nextAdapter.setAdapterDateTime(currentDateTime.minus(0, 1, 0, 0,
                        0, 0, 0, DateTime.DayOverflow.LastDay));
                nextAdapter.notifyDataSetChanged();
            ...
            // Swipe left
                ...
                prevAdapter.setAdapterDateTime(currentDateTime.plus(0, 1, 0,
                        0, 0, 0, 0, DateTime.DayOverflow.LastDay));
                prevAdapter.notifyDataSetChanged();
                mCalendar.add(Calendar.MONTH, +1);
            }
